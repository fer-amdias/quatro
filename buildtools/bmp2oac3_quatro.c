/* ********************************************************************** *
file: bmp2oac3_quatro.c
uso: bmp2oac3 file.bmp
Exemplo: bmp2oac3 display.bmp
Converte imagem display.bmp em arquivo display.mif para carregar na memoria 
...
Modificado para uso no jogo Quatro - 15/01/2026
 * ********************************************************************** */
...
int main(int argc, char** argv)
{
    ...
    nome[nc - 4] = '\0';    // inacreditavel que esqueceram de terminar a string com \0
    ...
    // coloca as dimensoes dos arquivos no comeco dos binarios
    fwrite(&width,1,sizeof(int32_t),aoutbin); 
    fwrite(&height,1,sizeof(int32_t),aoutbin);
