...
R_CA1_DRAW:
                imprimir_string(locale_ADICIONAIS_TITULO, 70, 124, 0x00FF, 0) # "Outras configuracoes"
        ...
        R_CA1_TEXTO_ATIVAR_GRAYSCALE:
                imprimir_string(locale_ADICIONAIS_ATIVAR_GRAYSCALE, 70, 134, 0x00FF, 0) # "1. Ativar grayscale"
                j R_CA1_TEXTO_EFEITO_DE_EXPLOSAO

        R_CA1_TEXTO_DESATIVAR_GRAYSCALE:
                imprimir_string(locale_ADICIONAIS_DESATIVAR_GRAYSCALE, 70, 134, 0x00FF, 0) # "1. Destivar grayscale"
        ...
        R_CA1_TEXTO_ATIVAR_EFEITO_DE_EXPLOSAO:
                imprimir_string(locale_ADICIONAIS_ATIVAR_EFEITO_DE_EXPLOSAO, 70, 144, 0x00FF, 0) # "2. Ativar efeito de explosao"
                j R_CA1_TEXTO_MODO_DEBUG

        R_CA1_TEXTO_DESATIVAR_EFEITO_DE_EXPLOSAO:
                imprimir_string(locale_ADICIONAIS_DESATIVAR_EFEITO_DE_EXPLOSAO, 70, 144, 0x00FF, 0) # "2. Desativar efeito de explosao"
        ...
        R_CA1_TEXTO_ATIVAR_MODO_DEBUG:
                imprimir_string(locale_ADICIONAIS_ATIVAR_MODO_DEBUG, 70, 154, 0x00FF, 0) # "3. Ativar modo debug"
                j R_CA1_TEXTO_OPCAO_9

        R_CA1_TEXTO_DESATIVAR_MODO_DEBUG:
                imprimir_string(locale_ADICIONAIS_DESATIVAR_MODO_DEBUG, 70, 154, 0x00FF, 0) # "3. Desativar modo debug"


        R_CA1_TEXTO_OPCAO_9:
                imprimir_string(locale_MENU_OPCAO9, 70, 164, 0x00FF, 0) # "9. Voltar"
