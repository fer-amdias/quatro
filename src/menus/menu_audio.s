...
R_MA1_AUDIO:
	...
	jal PROC_PREENCHER_TELA		# preenche a tela de preto
        ...
        imprimir_string(locale_AUDIO_TITULO, 70, 124, 0x00FF, 0) # "Configuracoes de audio"
...
R_MA1_TEXTO_MUTAR_MUSICA:
        imprimir_string(locale_AUDIO_MUTAR_MUSICA, 70, 134, 0x00FF, 0) # "1. Mutar musica"
        j R_MA1_TEXTO_EXPLOSOES

R_MA1_TEXTO_DESMUTAR_MUSICA:
        imprimir_string(locale_AUDIO_DESMUTAR_MUSICA, 70, 134, 0x00FF, 0) # "1. Desmutar musica"
...
R_MA1_TEXTO_MUTAR_EXPLOSOES:
        imprimir_string(locale_AUDIO_MUTAR_EXPLOSOES, 70, 144, 0x00FF, 0) # "2. Mutar explosoes"
        j R_MA1_TEXTO_OPCAO_9

R_MA1_TEXTO_DESMUTAR_EXPLOSOES:
        imprimir_string(locale_AUDIO_DESMUTAR_EXPLOSOES, 70, 144, 0x00FF, 0) # "2. Mutar explosoes"


R_MA1_TEXTO_OPCAO_9:
        imprimir_string(locale_MENU_OPCAO9, 70, 154, 0x00FF, 0) # "9. Voltar"
